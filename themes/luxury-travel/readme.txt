...
Luxury Travel WordPress Theme incorporates code from VW Fitness WordPress Theme, Copyright 2016 VW Themes
...
2 - Images Urls.
    ...
    Header image, Copyright Martinschuschi
    License:  CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/dubai-skyline-city-architecture-2292779/

    Deals image, Copyright pasja1000
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/bridge-river-bern-water-buildings-3491406/

    Deals image, Copyright Pexels
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/aerial-bangkok-city-night-traffic-2178705/

    Deals image, Copyright Free-Photos
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/new-york-city-brooklyn-bridge-night-336475/

    Deals image, Copyright MasashiWakui
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/japan-osaka-night-asia-landmark-2014619/

    Deals image, Copyright fxxu
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/mountains-bergsee-lake-1645078/
...
Luxury Travel Free version
====================
Luxury Travel Free version is compatible with GPL licensed.
...
Step 2. Go to customizer >> TG Settings >> Slider settings >> here you can select the page which you have add for slider.

For Deal And Discount
======================
...
Step 3. Add new page, In this page add the woocommerce category sortcode
"[products limit="8" columns="4" category="category-name"]"

Step 4. Go to customizer >> TG Settings >> Deal And Discount >> here you can select the page which you have add for Product.

For Himalaya Tours
====================

Step 1. Add the new post.

Step 2. GO to customizer >> TG Settings >> About Section >> Here you can add your post. 

For Top Bar
=============

Step 1. Go to customizer >> TG Settings >> Topbar Section >> here you can add contact details and offer details example free shipping, cash on delivery etc.

For Social icon
=================

Step 1. Go to customizer >> TG Settings >> Social Icon Section >> here you can add social links.
